export const translations = {
  fr: {
    ...
    "params.mlTitle": "Modèles Prédictifs & Machine Learning",
    "params.mlRun": "Entraîner les modèles",
    "params.mlRunning": "Entraînement en cours...",
    "params.mlStarting": "Démarrage...",
    "params.mlStarted": "Entraînement lancé en arrière-plan.",
    "params.mlAlreadyRunning": "Entraînement déjà en cours.",
    "params.mlStartFailed": "Impossible de lancer l'entraînement.",
    "params.mlLoading": "Lecture du statut ML...",
    "params.mlLastRun": "Dernier entraînement",
    "params.mlNoRun": "Aucun entraînement trouvé.",
  ...
  en: {
    ...
    "params.mlTitle": "Predictive Models & Machine Learning",
    "params.mlRun": "Train Models",
    "params.mlRunning": "Training in progress...",
    "params.mlStarting": "Starting...",
    "params.mlStarted": "Training started in background.",
    "params.mlAlreadyRunning": "Training already in progress.",
    "params.mlStartFailed": "Failed to start training.",
    "params.mlLoading": "Reading ML status...",
    "params.mlLastRun": "Last trained",
    "params.mlNoRun": "No training history found.",
  ...
  ar: {
    ...
    "params.mlTitle": "النماذج التنبؤية وتدريب الآلة",
    "params.mlRun": "تدريب النماذج",
    "params.mlRunning": "جاري التدريب...",
    "params.mlStarting": "جاري البدء...",
    "params.mlStarted": "بدأ تدريب النماذج في الخلفية.",
    "params.mlAlreadyRunning": "التدريب قيد التنفيذ بالفعل.",
    "params.mlStartFailed": "فشل بدء تدريب النماذج.",
    "params.mlLoading": "جاري قراءة حالة النماذج...",
    "params.mlLastRun": "آخر تدريب",
    "params.mlNoRun": "لم يتم العثور على تاريخ تدريب.",
