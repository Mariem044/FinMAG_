...
function ChartSkeleton({ type }) {
    ...
    return (
      <div className="w-full flex items-end justify-between gap-3 h-[200px] md:h-[280px] pt-4 px-2 animate-pulse">
        {Array.from({ length: 12 }).map((_, i) => (
          ...
          >
            <div
              className="w-full h-2/3 bg-gradient-to-t from-primary/10 to-primary/30 rounded-t-md transition-all duration-500"
    ...
    return (
      <div className="w-full flex items-center justify-center gap-8 h-[200px] md:h-[280px] animate-pulse">
        <div className="relative w-40 h-40 md:w-44 md:h-44 rounded-full border-[16px] border-surface-hover flex items-center justify-center">
          <div
            className="absolute inset-0 rounded-full border-[16px] border-primary/20 border-t-primary/40 border-r-primary/30 animate-spin"
  ...
  if (type === "line") {
    return (
      <div className="w-full h-[200px] md:h-[280px] relative pt-4 animate-pulse flex flex-col justify-between">
        ...
        <div className="w-full h-[180px] rounded-lg bg-gradient-to-r from-primary/5 via-primary/20 to-primary/5" />
  ...
  return (
    <div className="w-full h-[200px] md:h-[280px] relative pt-4 animate-pulse flex flex-col justify-between">
      ...
      <div className="relative flex-1 rounded-lg bg-gradient-to-br from-primary/5 via-transparent to-primary/10" />
      <div className="flex justify-between px-1">
